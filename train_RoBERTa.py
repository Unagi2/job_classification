...
from inference import predict, predict_roberta
from model_RoBERTa import Classifier_RoBERTa
from preprocess import make_dataset_roberta, make_folded_df
...
def trainer(params, fold, df, result_dir):
    ...
    train_dataset = make_dataset_roberta(params, train_df, tokenizer)
    valid_dataset = make_dataset_roberta(params, valid_df, tokenizer)
    ...
    model = Classifier_RoBERTa(params.model_name, num_classes=params.num_classes)
